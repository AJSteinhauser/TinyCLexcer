...
ASSIGNMENT_STATEMENT : IDENTIFIER ASSIGNMENT EXPRESSION SEMI_COLON {$$ = newNode($1, ASSIGNMENT_STATEMENT, $3,NULL,NULL);}
					 | TYPE IDENTIFIER ASSIGNMENT EXPRESSION SEMI_COLON {$$ = newNode($2, ASSIGNMENT_STATEMENT,$4,NULL,NULL);}
					 ;
...
FUNCTION_DEFINITION : RETURN_TYPE IDENTIFIER OPEN_PAR FUNCTION_PARAMETER_LIST CLOSE_PAR  FUNCTION_BODY {$$ = newNode($2, FUNCTION_DEFINITION,$4,$6,NULL);}
					| RETURN_TYPE IDENTIFIER OPEN_PAR VOID CLOSE_PAR FUNCTION_BODY {$$ = newNode($2, FUNCTION_DEFINITION,NULL,$6, NULL);}
					;
