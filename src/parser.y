...
FUNCTION_DEFINITION : RETURN_TYPE IDENTIFIER OPEN_PAR FUNCTION_PARAMETER_LIST CLOSE_PAR  FUNCTION_BODY {printf("%s",$2); $$ = newNode(-1, FUNCTION_DEFINITION,$4,$6,NULL);}
					| RETURN_TYPE IDENTIFIER OPEN_PAR VOID CLOSE_PAR FUNCTION_BODY {printf("%s",$2); $$ = newNode(-1, FUNCTION_DEFINITION,NULL,$6, NULL);}
					;
